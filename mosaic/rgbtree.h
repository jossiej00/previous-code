...
public:
   ...
   * 
    ...
    * We leave the design decision on how to handle empty subtrees to you!
    ...
    RGBAPixel findNNHelper(const RGBAPixel & query, int start, int end, int d) const;
  ...
  /* nearest neighbor function.                                     */
    ...
    bool smallerByDim(const RGBAPixel& first, const RGBAPixel& second,
                       int curDim) const;
    int distBetween(const RGBAPixel & first, const RGBAPixel & second) const;
    ...
    */
    ...
    int getColor(RGBAPixel pixel, int d) const;
